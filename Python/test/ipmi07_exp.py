...
from dwmri import MOWReconstructor
from dwmri import DOTReconstructor
from dwmri import QBIReconstructor
...
def main():
    """
    reproduce the Fig5 in the ipmi07 paper
    @INPROCEEDINGS{Jian&Vemuri_ipmi07,
      ...
      booktitle = {20th International Conference on Information Processing in Medical Imaging},
      year = {2007},
    }
    """
    save_result('2fib_result.txt')
    plot_errorbar('2fib_result.txt','2fib_figure')
